    ...
    if 'campaigns' in tables:
        ...
        with db.engine.begin() as conn:
            if 'is_deleted' not in cols:
                conn.execute(text('ALTER TABLE campaigns ADD COLUMN is_deleted BOOLEAN DEFAULT 0'))
            ...
            conn.execute(text('UPDATE campaigns SET is_deleted = 0 WHERE is_deleted IS NULL'))
